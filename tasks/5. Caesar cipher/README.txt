...
Implement a function that takes a string and a numeric key, and returns the caesar encrypted version of that string shifting the english ABC with the key.
...
Bonus: Implement the function which decrypts an encrypted text, if we know the key. Give more solutions based on different logics if you can.